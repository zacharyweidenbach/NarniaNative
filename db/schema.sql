...
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (2, 3, "https://s30.postimg.org/vvip08hcx/cat_fashion_septem_1773575i_jpg_0.jpg", "I love to dress my cat in pretty clothes.", "image", "3456871350");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (4, 9, "https://s28.postimg.org/i9t0h18r1/cat_fashion_may_1773579i.jpg", "Hi, my name is Zach and this is my cat.", "image", "3456871351");
...
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (2, 3, "https://s29.postimg.org/fqxuf4tvr/Lovely_Letters_Print_Hooded_Pets_Clothing.jpg", "Check this outfit out. It's lit!", "image", "3456831350");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (4, 9, "https://s30.postimg.org/79wqlenrl/dog_wearing_coat_and_hat.jpg", "This is a cute doggy in cute clothes!", "image", "3456851351");
...
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (1, 8, "https://s23.postimg.org/v3jsnaoij/Fashion_cotton_superman_dog_clothes_cute_chihuah.jpg", "This outfit is fantastic!", "image", "3456874359");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (2, 3, "https://s23.postimg.org/4htuoangr/New_Arrival_Lovely_Totoro_and_Lion_Design_Pet_Co.jpg", "Outfit, outfit, outfit, outfit, outfit!!!", "image", "5456831350");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (4, 9, "https://s29.postimg.org/4pdzd22hj/desktop_1420820766.jpg", "Hi, my name is Zach and this is my outfit.", "image", "3476871351");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (3, 5, "https://s23.postimg.org/tw90t5f97/2016_Yellow_Minions_Pet_Dog_Clothes_Cartoon_Dog.jpg", "Check out this awesome outfit I just put together!", "image", "3456871948");
...
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (4, 9, "https://s27.postimg.org/yq56tf26r/Honden_Beer_Gedrukt_Pyjama_Jas_Kat_Puppy_Cozy_Kl.jpg", "This outfit is too cute.", "image", "5456871351");
