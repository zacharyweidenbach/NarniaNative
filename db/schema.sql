...
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (3, 5, "https://s23.postimg.org/ev70eu6cb/cat_images_funny_picture.jpg", "Check out this awesome outfit I just put together!", "image", "1484454926");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (1, 8, "https://s30.postimg.org/olxg2hsld/cat_images_funny_pictures_kitties.jpg", "What am I doing with my life?", "image", "1484454927");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (2, 3, "https://s30.postimg.org/vvip08hcx/cat_fashion_septem_1773575i_jpg_0.jpg", "I love to dress my cat in pretty clothes.", "image", "1484454928");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (4, 9, "https://s28.postimg.org/i9t0h18r1/cat_fashion_may_1773579i.jpg", "Hi, my name is Zach and this is my cat.", "image", "1484454929");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (3, 5, "https://s-media-cache-ak0.pinimg.com/originals/c8/4e/d1/c84ed12bf5414ef6c7ab228a2f947961.jpg", "Check out this awesome outfit I just put together this morning!", "image", "1484454930");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (1, 8, "https://ae01.alicdn.com/kf/HTB1IK3YHVXXXXcrXFXXq6xXFXXX8/Puppy-Spring-Summer-Cotton-Dogs-Vests-Clothes-White-Side-Black-Square-Dog-Vest-Pet-T-shirt.jpg_640x640.jpg", "Puppy vests? Yes please!", "image", "1484454931");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (2, 3, "https://s29.postimg.org/fqxuf4tvr/Lovely_Letters_Print_Hooded_Pets_Clothing.jpg", "Check this outfit out. It's lit!", "image", "1484454932");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (4, 9, "https://s30.postimg.org/79wqlenrl/dog_wearing_coat_and_hat.jpg", "This is a cute doggy in cute clothes!", "image", "1484454933");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (3, 5, "https://ae01.alicdn.com/kf/HTB100haHVXXXXXKXpXXq6xXFXXX9/Rainbow-cute-girl-pet-dog-clothes-apparel-spring-summer-puppy-dress-clothing-for-dogs-Dog-Supplies.jpg_640x640.jpg", "Check out this awesome outfit I just put together!", "image", "1484454934");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (1, 8, "https://s23.postimg.org/v3jsnaoij/Fashion_cotton_superman_dog_clothes_cute_chihuah.jpg", "This outfit is fantastic!", "image", "1484454935");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (2, 3, "https://s23.postimg.org/4htuoangr/New_Arrival_Lovely_Totoro_and_Lion_Design_Pet_Co.jpg", "Outfit, outfit, outfit, outfit, outfit!!!", "image", "1484454936");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (4, 9, "https://s29.postimg.org/4pdzd22hj/desktop_1420820766.jpg", "Hi, my name is Zach and this is my outfit.", "image", "1484454937");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (3, 5, "https://s23.postimg.org/tw90t5f97/2016_Yellow_Minions_Pet_Dog_Clothes_Cartoon_Dog.jpg", "Check out this awesome outfit I just put together!", "image", "1484454938");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (1, 8, "https://ae01.alicdn.com/kf/HTB1ScHbLFXXXXa1XpXXq6xXFXXX6/Funny-font-b-Pet-b-font-font-b-Cat-b-font-Pirate-font-b-Costume-b.jpg", "This is looking good so far.", "image", "1484454939");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (2, 3, "https://s-media-cache-ak0.pinimg.com/736x/ab/2e/32/ab2e32b0e8c5273372217713fb146165.jpg", "What an amazing outfit!", "image", "1484454940");
INSERT INTO `posts` (userId, likesCount, body, description, type, createdAt) VALUES (4, 9, "https://s27.postimg.org/yq56tf26r/Honden_Beer_Gedrukt_Pyjama_Jas_Kat_Puppy_Cozy_Kl.jpg", "This outfit is too cute.", "image", UNIX_TIMESTAMP());

INSERT INTO `posts` (postId, userId, body, type, createdAt) VALUES (1, 1, "Some people come into our lives and leave footprints on our hearts, while others come into our lives and make us wanna leave footprints on their face.", "comment", "1484454942");
INSERT INTO `posts` (postId, userId, body, type, createdAt) VALUES (1, 2, "this is a comment on Rick's post by Haris", "comment", "1484454943");
INSERT INTO `posts` (postId, userId, body, type, createdAt) VALUES (1, 4, "I am ready to meet my Maker. Whether my Maker is prepared for the great ordeal of meeting me is another matter.", "comment", "1484454944");
INSERT INTO `posts` (postId, userId, body, type, createdAt) VALUES (2, 2, "Sorry, I can't hangout. My uncle's cousin's sister in law's best friend's insurance agent's roommate's pet goldfish died. Maybe next time.", "comment", "1484454945");
INSERT INTO `posts` (postId, userId, body, type, createdAt) VALUES (2, 3, "Why go to college? There's Google.", "comment", "1484454946");
INSERT INTO `posts` (postId, userId, body, type, createdAt) VALUES (2, 4, "I feel sorry for people who don't drink. When they wake up in the morning, that's as good as they're going to feel all day.", "comment", "1484454947");
INSERT INTO `posts` (postId, userId, body, type, createdAt) VALUES (3, 1, "Don't you find it Funny that after Monday(M) and Tuesday(T), the rest of the week says WTF?", "comment", "1484454948");
INSERT INTO `posts` (postId, userId, body, type, createdAt) VALUES (3, 3, "Microsoft bought Skype for 8.5 billion!.. what a bunch of idiots! I downloaded it for free!", "comment", "1484454949");
INSERT INTO `posts` (postId, userId, body, type, createdAt) VALUES (3, 4, "Life is full of temporary situations, ultimately ending in a permanent solution.", "comment", "1484454950");
INSERT INTO `posts` (postId, userId, body, type, createdAt) VALUES (4, 1, "A good lawyer knows the law; a clever one takes the judge to lunch.", "comment", "1484454951");
INSERT INTO `posts` (postId, userId, body, type, createdAt) VALUES (4, 2, "After one look at this planet any visitor from outer space would say “I WANT TO SEE THE MANAGER.”", "comment", "1484454952");
INSERT INTO `posts` (postId, userId, body, type, createdAt) VALUES (4, 3, "The human body was designed by a civil engineer. Who else would run a toxic waste pipeline through a recreational area?", "comment", UNIX_TIMESTAMP());
