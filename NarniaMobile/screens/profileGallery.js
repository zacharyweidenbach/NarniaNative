...
var LikesGallery = (props) => {
  return (
    <View style={styles.container}>
      ...
      <View>
        <Image style={styles.imgLarge} source={require('../assets/images/post2.jpg')} />
      </View>
      <View>
      ...
      <View>
        <Image style={styles.imgLarge} source={require('../assets/images/post6.jpg')} />
      </View>
      <View>
      ...
      <View>
        <Image style={styles.imgLarge} source={require('../assets/images/post9.jpg')} />
      </View>
    </View>
  );
};
