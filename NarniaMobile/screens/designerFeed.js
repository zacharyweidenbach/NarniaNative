...
var DesignerFeed = (props) => {
  return (
    <View style={styles.container}>
      ...
      <View>
        <Image style={styles.imgContainer} source={require('../assets/images/post4.jpg')} />
      </View>
      ...
      <View>
        <Image style={styles.imgContainer} source={require('../assets/images/post5.jpg')} />
      </View>
      <View style={styles.likesContainer}>
      ...
      <View>
        <Image style={styles.imgContainer} source={require('../assets/images/post6.jpg')} />
      </View>
      <View style={styles.likesContainer}>
